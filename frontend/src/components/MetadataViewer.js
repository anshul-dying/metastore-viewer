...
const getFileIcon = (extension) => {
    ...
    const getFileIcon = (extension, isDirectory) => {
        const ext = extension.toLowerCase();
        if (isDirectory) return <FaFileAlt className="text-gray-500" />;
        if (["xls", "xlsx", "csv"].includes(ext)) return <FaFileExcel className="text-green-500" />;
        if (["pdf"].includes(ext)) return <FaFilePdf className="text-red-500" />;
        if (["jpg", "jpeg", "png", "gif"].includes(ext)) return <FaFileImage className="text-yellow-500" />;
                                                                                ...
                                                                                <React.Fragment key={item.file}>
                                                                                    <tr className={darkMode ? "hover:bg-gray-600" : "hover:bg-gray-100"}>
                                                                                        <td className="px-6 py-4 font-mono flex items-center space-x-2">
                                                                                            {getFileIcon(item.extension, item.file.endsWith("/"))}
                                                                                            <span>{item.file}</span>
                                                                                        </td>
                                                                                        ...
                                                                                        <td className="px-6 py-4">
                                                                                            <div className="flex space-x-2">
                                                                                                ...
                                                                                                {(item.details?.format === "parquet" ||
                                                                                                    item.details?.format === "parquet_directory" ||
                                                                                                    item.details?.format === "delta" ||
                                                                                                    item.details?.format === "iceberg" ||
                                                                                                    item.details?.format === "hudi") && (
                                                                                                        <button
                                                                                                                    ...
                                                                                                                    {Object.keys(dataMap[item.file].data[0] || {}).map((key) => (
                                                                                                                        <div key={key} className="flex items-center space-x-2">
                                                                                                                            ...
                                                                                                                            <button
                                                                                                                                ...
                                                                                                                                className={`text-sm px-2 py-1 rounded ${pinnedColumns[item.file]?.[key]
                                                                                                                            ...
                                                                                                                            <tr className="bg-subtle-gray dark:bg-medium-gray sticky top-0 z-10">
                                                                                                                                {Object.keys(dataMap[item.file].data[0] || {})
                                                                                                                                    ...
                                                                                                                                    .map((key, idx) => (
                                                                                                                                        <th
                                                                                                                                            key={key}
                                                                                                                                            className={`border p-2 whitespace-nowrap text-medium-gray dark:text-white ${pinnedColumns[item.file]?.[key] ? "sticky z-20 bg-inherit" : ""
                                                                                                                                                }`}
                                                                                                                                            style={{
                                                                                                                                                minWidth: "150px",
                                                                                                                                ...
                                                                                                                                <tr key={idx} className="hover:bg-accent-blue/10 dark:hover:bg-white/10 transition-all duration-200">
                                                                                                                                    {Object.keys(row)
                                                                                                                                        ...
                                                                                                                                        .map((key, i) => (
                                                                                                                                            <td
                                                                                                                                                key={i}
                                                                                                                                                className={`border p-2 whitespace-nowrap text-medium-gray dark:text-white ${pinnedColumns[item.file]?.[key] ? "sticky z-10 bg-inherit" : ""
                                                                                                                                                    }`}
                                                                                                                                                style={{
                                                                                                                                                    minWidth: "150px",
                                                                                                                                                    left: pinnedColumns[item.file]?.[key]
